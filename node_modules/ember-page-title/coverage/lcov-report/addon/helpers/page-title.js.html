...
<html lang="en">
<head>
    <title>Code coverage report for addon/helpers/page-title.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">addon/helpers/</a> page-title.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    if (activeTransition) {
      activeTransition.promise.finally(function () {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (headData.isDestroyed) { <span class="cstat-no" title="statement not covered" >return; </span>}
